...
/*
   6_pack_external_XYYZ_RS485_Relay_Mist_5V_Flood
    ...
    2021-06-03  Bart Dring for John Johnson
...
*/
#define MACHINE_NAME            "6 Pack External XYYZ RS485 Mist Flood"
...
#define COOLANT_MIST_PIN  GPIO_NUM_26 // Relay for Mist on module socket #3


// RS485 Modbus In socket #4
// https://github.com/bdring/6-Pack_CNC_Controller/wiki/RS485-Modbus-Module
#define SPINDLE_TYPE            SpindleType::YL620 // default, check actual $Spindle/Type Setting
...
#define COOLANT_FLOOD_PIN       I2SO(24) // No PWM
#define USER_DIGITAL_PIN_0      I2SO(25)
#define USER_DIGITAL_PIN_1      I2SO(26) //  M7 on M9 Off
#define USER_DIGITAL_PIN_2      I2SO(27) //  M8 on M9 Off
