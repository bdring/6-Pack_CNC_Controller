...
/*
   6_pack_external_XYYZ_RS485_Laser_Mist.h
    ...
    2021-03-07  Bart Dring for Craig Z.
...
#define COOLANT_MIST_PIN              GPIO_NUM_26  // M7 M9
#define COOLANT_FLOOD_PIN             GPIO_NUM_4   // M8 M9
#define USER_DIGITAL_PIN_0            GPIO_NUM_16  // M62 P0 (on) M63 P0 (off)
#define USER_DIGITAL_PIN_1            GPIO_NUM_27  // M62 P0 (on) M63 P0 (off)
