...
/*
    6_pack_stepstick_XYYZ_SWXYZP_Spin_Laser.h
    Covers all V1 versions V1p0, V1p1, etc

    Part of Grbl_ESP32
    Pin assignments for the ESP32 I2S 6-axis board

    2021-02-26 B. Dring for Michel B.

    Motors: XYYZ

    Switches: 2 switches per axis

    Probe: Yes

    Spindle: Relay in socket #3

    Laser: 5V Module in socket #4   // Send $Spindle/Type=LASER or $Spindle/Type=RELAY to toggle between types

    Mist: Relay in socket #5
...
*/
#define MACHINE_NAME            "6 Pack XYYZ Spindle Laser"
