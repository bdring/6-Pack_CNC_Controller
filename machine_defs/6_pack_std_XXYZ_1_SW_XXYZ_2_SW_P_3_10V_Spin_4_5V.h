...
/*
    6_pack_std_XXYZ_1_SW_XXYZ_2_SW_P_3_10V_Spin_4_5V.h


    Part of Grbl_ESP32

    Pin assignments for the ESP32 6 Pack Controller
    2020-09- 21    - Bart Dring for Briton Rice
...
*/
#define MACHINE_NAME            "6 Pack Standard XXYZ SW1_XXYZ SW2_P 10V 5V"
...
#define X_STEPPER_MS3           I2SO(3)   // Motor Socket 1
#define X2_STEPPER_MS3          I2SO(6)   // Motor Socket #2
#define Y_STEPPER_MS3           I2SO(11)  // Motor Socket #3
#define Z_STEPPER_MS3           I2SO(14)  // Motor Socket #4
