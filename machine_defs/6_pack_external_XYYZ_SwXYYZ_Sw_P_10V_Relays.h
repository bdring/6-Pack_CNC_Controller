...
/*
    6_pack_external_XYYZ_SwXYYZ_Sw_P_10V_Relays.h
...
// https://github.com/bdring/6-Pack_CNC_Controller/wiki/Relay-Module
// Relay module as flood on CNC I/O Module socket #5
#define COOLANT_FLOOD_PIN  I2SO(24)
