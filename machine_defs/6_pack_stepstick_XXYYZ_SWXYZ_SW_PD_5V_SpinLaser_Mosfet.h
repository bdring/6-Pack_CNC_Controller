...
/*
    6_pack_stepstick_XXYYZ_SWXYZ_SW_PD_5V_SpinLaser_Mosfet.h
...
*/
#define MACHINE_NAME            "6 Pack Controller StepStick XXYYZ"
...
#define INVERT_CONTROL_PIN_MASK B0000001 // invert door
